"""Arranque de la DEMO de Vigil Ponente en un solo comando: web + API.
...
os.environ.setdefault("VIGIL_PONENTE_DEMO", "1")
...
os.environ.setdefault("VIGIL_PONENTE_OUTPUT_DIR", os.path.join(_AQUI, "salida_ponente_demo"))
